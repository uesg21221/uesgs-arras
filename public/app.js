...
function drawMinimapAndDebug(spacing, alcoveSize) {
    ...
    // Text
    if (global.showDebug) {
        drawText("this is totally arras.io trust me", x + len, y - 50 - 5 * 14 - 2, 15, "#FFFFFF", "right");
        ...
        drawText("this is totally arras.io trust me", x + len, y - 50 - 2 * 14 - 2, 15, "#FFFFFF", "right");
        drawText((100 * gui.fps).toFixed(2) + "% : " + global.metrics.rendertime + " FPS", x + len, y - 50 - 1 * 14, 10, global.metrics.rendertime > 10 ? color.guiwhite : color.orange, "right");
...
const gameDrawDead = () => {
    ...
    drawText("U are ded, not a big surprise.", x, y - 80, 8, color.guiwhite, "center");
