...
const { forcefield } = require('./modules/definitions/groups/generics.js');
    ...
    switch (true) {
        case instance.type === "wall" || other.type === "wall":
            ...
            case instance.type === "aegis" || other.type === "aegis":
                ...
                if (instance.type === "aura" || other.type === "aura") return;
                if (instance.type === "forcefield" || other.type === "forcefield") return;
                if (instance.type === "absorber" || other.type === "absorber") return;
                if (instance.type === 'Piercing Bullet' || other.type  === 'Piercing Bullet') return;
                if (instance.isDominator || other.isDominator) return;
            ...
            break;
                ...
                case instance.type === "forcefield" || other.type === "forcefield":
                if (instance.type === "forcefield" && other.type === "forcefield") return;
                if (instance.type === "aura" || other.type === "aura") return;
                if (instance.type === "aegis" || other.type === "aegis") return;
                if (instance.type === "absorber" || other.type === "absorber") return;
                ...
                if (instance.isDominator || other.isDominator) return;
                if (instance.team == other.team) return;
                let forcefield = instance.type === "forcefield" ? instance : other;
                let entity3 = instance.type === "forcefield" ? other : instance;
                if (entity3.ac || entity3.master.ac) return;
                reflectcollide(forcefield, entity3);
                advancedcollide(forcefield, entity3, true, true);
            break;

                case instance.type === "absorber" || other.type === "absorber":
                if (instance.type === "absorber" && other.type === "absorber") return;
                if (instance.type === "aura" || other.type === "aura") return;
                if (instance.type === "aegis" || other.type === "aegis") return;
                if (instance.type === "forcefield" || other.type === "forcefield") return;
                ...
                if (instance.isDominator || other.isDominator) return;
                if (instance.team == other.team) return;
                let absorber = instance.type === "absorber" ? instance : other;
                let entity4 = instance.type === "absorber" ? other : instance;
                if (entity4.ac || entity4.master.ac) return;
                reflectcollide(absorber, entity4);
            break;
        ...
        case (instance.type === "crasher" && other.type === "food") ||
            ...
            case instance.team !== other.team:
                ...
                if ((instance.type === "aura" && other.type === "trap") || 
                (other.type === "aura" && instance.type === "trap")) return;
                if ((instance.type === "aura" && other.type === "drone") || 
                (other.type === "aura" && instance.type === "drone")) return;
                if ((instance.type === "aura" && other.type === "swarm") || 
                (other.type === "aura" && instance.type === "swarm")) return;
...
const foodTypes = [
    ...
    new FoodType("Splitter Food",
        [Class.splitterSquare, Class.splitterTriangle, Class.splitterPentagon],
        ["scale", 2], 150
    ),
    new FoodType("Big Splitter Food",
        [Class.splitterSplitterSquare, Class.splitterSplitterSplitterSquare],
        ["scale", 2], 20
    ),
    new FoodType("Nest Splitter Food",
        [Class.splitterPentagon, Class.splitterSplitterPentagon, Class.splitter3Pentagon],
        ["scale", 2], 0.4, true
    ), 
