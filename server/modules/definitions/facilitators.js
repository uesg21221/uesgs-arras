...
exports.addAura = (isHeal, auraColor) => {
        ...
        GUNS: [
            {
                ...
                PROPERTIES: {
                    SHOOT_SETTINGS: exports.combineStats([g.aura]),
        ...
        TURRETS: [
            {
                ...
                TYPE: [symbolType, {COLOR: auraColor, LAYER: 6}],
            },
        ]
    };
}
exports.addAegis = (aegisColor, type, aegisStats) => {
    let aegisType;
    let symbolType;
    if (type == 4) {
        aegisType = 'megaAbsorber',
        ...
        GUNS: [
            {
                ...
                PROPERTIES: {//RELOAD RECOIL SHUDDER  SIZE   HEALTH  DAMAGE   PEN    SPEED    MAX    RANGE  DENSITY  SPRAY   RESIST
                    SHOOT_SETTINGS: exports.combineStats([g.aegis,aegisStats]),
