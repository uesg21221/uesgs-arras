const { combineStats, makeAuto, makeHybrid, makeOver, makeDeco, makeGuard, addAura, addAegis } = require('../facilitators.js');
...
exports.snipedestroy = {
  ...
  exports.snipedestroybrid = makeHybrid(exports.snipedestroy, "Trainwreck");
  exports.snipeanni = {
    PARENT: ['genericTank'],
    DANGER: 6,
    BODY: {
    ...
    GUNS: [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni, g.morespeed]),
          TYPE: 'bullet',
        },
      },
      {
        POSITION: [13, 19.5, 1, 4, 0, 0, 0],
      },
      {
        POSITION: [13, 8, 1.3, 4, 0, 0, 0],
      },
    ],
  };
  exports.bobcat = {
    ...
    GUNS: [
      {
        ...
        POSITION: [5, 7, 1.9, 19.5, 0, 0, 0],
      },
      {
        POSITION: [19.5, 7, 1, 0, 0, 0, 0],
      },
      {
        POSITION: [5, 3, -2, 20.2, 0, 0, 0],
      },
      {
        POSITION: [3, 7, -1.6, 8.5, 0, 0, 0],
      },
      {
        POSITION: [7, 14, 1, 25, 0, 0, 0],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.basic,
            g.pound,
  ...
  exports.aegisBasicGen = addAegis('default', 1, g.blank);
                exports.aegisBasic = {
                    PARENT: ['genericTank'],
                    LABEL: "Aegis Basic",
                    GUNS: [
                ...
                exports.forcefieldBasicGen = addAegis('default', 2, g.blank);
                exports.forcefieldBasic = {
                    ...
                    TURRETS: [
                        {
                            POSITION: [14, 0, 0, 0, 360, 1],
                            TYPE: ['forcefieldBasicGen']
                        }
                    ],
                };
                exports.absorberBasicGen = addAegis('default', 3, g.blank);
                exports.absorberBasic = {
                    ...
                    TURRETS: [
                        {
                            POSITION: [14, 0, 0, 0, 360, 1],
                            TYPE: ['absorberBasicGen']
                        }
                    ],
                };
                exports.auraBasicGen = addAura(false, 0);
exports.auraBasic = {
    PARENT: ["genericTank"],
    LABEL: "Aura Basic",
    GUNS: [
...
exports.superHeavyGun = {
    ...
    GUNS: [{
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.power, g.turret, g.bitlessspeed]),
            TYPE: 'bullet'
        }
    }, {
  ...
  exports.autoDestroyer = makeAuto(exports.destroyer, 'Auto-Destroyer')
  exports.superDestroyer = makeAuto(exports.destroyer, 'Super-Destroyer',{ 
    type: "superHeavyGun",
    size: 14, })
...
exports.obliterator = {
    ...
    GUNS: [
        {
            POSITION: [13.5, 24, 1, 7, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.obli]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [6.5, 14, 1.7, 0, 0, 0, 0],
        },
    ],
};

// TANK UPGRADE PATHS
exports.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "auraBasic", "forcefieldBasic"/* "whirlwind"*/];
    exports.basic.UPGRADES_TIER_2 = ["smasher"];
        exports.smasher.UPGRADES_TIER_3 = ["megaSmasher", "spike", "autoSmasher", "landmine"];

    exports.aegisBasic.UPGRADES_TIER_2 = ["forcefieldBasic"];
    ...
    exports.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper"];
        ...
        exports.auto3.UPGRADES_TIER_3 = ["auto5", "mega3", "auto4", "banshee"/*, "whirl3"*/];
            exports.mega3.UPGRADES_TIER_4 = ["super3", "destruction","mega5","giga3"];
            exports.auto5.UPGRADES_TIER_4 = ["mega5"];
    ...
    exports.pounder.UPGRADES_TIER_2 = ["destroyer", "builder", "artillery", "launcher"];
        ...
        exports.destroyer.UPGRADES_TIER_3 = ["conqueror", "annihilator", "hybrid", "construct", "snipedestroy", "autoDestroyer"];
            exports.autoDestroyer.UPGRADES_TIER_4 = ["superDestroyer", "destruction"];
            exports.snipedestroy.UPGRADES_TIER_4 = ["snipedestroybrid", "snipeanni", "bobcat"];
            exports.annihilator.UPGRADES_TIER_4 = ["snipeanni", "obliterator"];
