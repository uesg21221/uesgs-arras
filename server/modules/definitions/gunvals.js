...
module.exports = {
    ...
    power: { shudder: 0.6, size: 1, pen: 1.25, speed: 2, maxSpeed: 1.7, density: 2, spray: 0.5, resist: 1.5 },
    ...
    gunnerDominator: { reload: 1, recoil: 0, shudder: 1.1, size: 0.5, health: 0.5, damage: 0.5, speed: 1.5, density: 0.9, spray: 1.2, resist: 0.8 },
    ...
    destroy: { reload: 2.2, recoil: 1.8, shudder: 0.5, health: 2, damage: 2, pen: 1.2, speed: 0.8, maxSpeed: 0.8, density: 2, resist: 3 },
    anni: { reload: 0.8, recoil: 1.25 },
    obli: { reload: 0.6, recoil: 1.5 },
    ...
    destroyerDominator: { reload: 4, recoil: 0, size: 1, health: 6, damage: 6, pen: 6, speed: 1, maxSpeed: 1, spray: 0.5 },
    ...
    trapperDominator: { reload: 0.8, recoil: 0, shudder: 0.25, health: 1.25, damage: 1.45, pen: 1.6, speed: 0.75, maxSpeed: 2, range: 0.7, spray: 0.5 },
    ...
    muchbigger: { size: 1.8 },
    doublesize: { size: 2 },
    twoandhalfsize: { size: 2.5 },
    triplesize: { size: 3 },
    quadruplesize: { size: 4 },
    ...
    aegis: {reload: 250,recoil: 0.001, shudder: 0.001, size: 6, damage: 0.001, speed: 0.001, maxSpeed: 0.001, spray: 0.001 },
