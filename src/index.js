...
function collide(collision) {
    ...
    if ((!instance.activation.active && !other.activation.active) || (instance.isArenaCloser && !instance.alpha) || (other.isArenaCloser && !other.alpha)) return 0;
    switch (true) {
        ...
        case instance.team === other.team && (instance.settings.hitsOwnType === 'pushOnlyTeam' || other.settings.hitsOwnType === 'pushOnlyTeam'):
            {
                ...
                if (instance.settings.hitsOwnType === other.settings.hitsOwnType || entity.settings.hitsOwnType === 'never') return;
                let a = 1 + 10 / (Math.max(entity.velocity.length, pusher.velocity.length) + 10);
                advancedcollide(pusher, entity, false, false, a);
            }
            break;
        case (instance.type === 'crasher' && other.type === 'food' && instance.team === other.team) || (other.type === 'crasher' && instance.type === 'food' && other.team === instance.team):
            ...
            switch (instance.settings.hitsOwnType) {
                case 'assembler': {
                    ...
                    if (
                        ...
                        target1.isDead() ||
                        target2.isDead() ||
                        (target1.parent.id != target2.parent.id && target1.parent.id != null && target2.parent.id != null) // idk why
                    ) {
