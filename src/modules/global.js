...
global.makeHitbox = (wall) => {
    ...
    let relativeCorners = [Math.atan2(_size, _size) + wall.angle, Math.atan2(0 - _size, _size) + wall.angle, Math.atan2(0 - _size, 0 - _size) + wall.angle, Math.atan2(_size, 0 - _size) + wall.angle],
...
for (let file of requires) {
    ...
    for (let key in module) {
        if (Object.prototype.hasOwnProperty.call(module, key)) global[key] = module[key];
    }
}
