let compressMovementOffsets = [
    ...
    collisionLineLine = (p10, p11, q10, q11, p20, p21, q20, q21) => {
        ...
        return (o1 == 0 && CLLonSegment(p10, p11, p20, p21, q10, q11)) || (o2 == 0 && CLLonSegment(p10, p11, q20, q21, q10, q11)) || (o3 == 0 && CLLonSegment(p20, p21, p10, p11, q20, q21)) || (o4 == 0 && CLLonSegment(p20, p21, q10, q11, q20, q21)) || (o1 != o2 && o3 != o4);
    },
    ...
    wouldHitWall = (me, enemy) => {
        ...
        for (let i = 0; i < walls.length; i++) {
            ...
            for (let j = 0; j < crate.hitbox.length; j++) {
                ...
                if (collisionLineLine(me.x, me.y, enemy.x, enemy.y, crate.x + hitboxLine[0].x, crate.y + hitboxLine[0].y, crate.x + hitboxLine[1].x, crate.y + hitboxLine[1].y)) return true;
            }
        }
        return false;
    };
...
class io_wanderAroundMap extends IO {
    ...
    think(input) {
        if (new Vector(this.body.x - this.spot.x, this.body.y - this.spot.y).isShorterThan(50) || wouldHitWall(this.body, this.spot)) {
            this.spot = ran.choose(room.spawnableDefault).loc;
        }
