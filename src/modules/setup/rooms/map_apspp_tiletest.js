let {portal: port} = require('../tiles/portal.js'),
    ...
    {dominatorBlue: dBlu, dominatorGreen: dGrn, dominatorContested: dCon, sanctuaryBlue: sBlu, sanctuaryGreen: sGrn, sanctuaryContested: sCon} = require('../tiles/dominators.js'),
    {
        base1: b1np,
        base1protected: b1hp,
        base2: b2np,
