    ...
    labyrinthFoodTypes = [
        ...
        [
            ...
            [
                ...
                [9, 'legendaryTriangle'],
                [9, 'legendaryPentagon'],
                [5, 'legendaryBetaPentagon'],
                [3, 'legendaryAlphaPentagon'],
            ],
        ],
        [
            Math.pow(4, -2),
            [
                /*[16807, 'egg'], */ [3, 'shadowSquare'],
                [9, 'shadowTriangle'],
                [9, 'shadowPentagon'],
                [5, 'shadowBetaPentagon'],
                [3, 'shadowAlphaPentagon'],
            ],
        ],
        [
            Math.pow(4, -3),
            [
                /*[65536, 'egg'], */ [9, 'rainbowSquare'],
                [27, 'rainbowTriangle'],
                [9, 'rainbowPentagon'],
                [3, 'rainbowBetaPentagon'],
